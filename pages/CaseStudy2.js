  ...
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <div className="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
      ...
      <main className="m-auto max-w-2xl mt-36 text-center text-xl">
        ...
        <img src='/img/Agreements.png' alt="Picture of the author" width="800" className="m-auto mt-8"/>
        ...
        <div className="mt-36 text-left mx-4 md:mx-0">
            ...
            <img src='/img/agreements/IMG_4803.png' alt="Picture of the author" width="800" className="m-auto mt-8"/>
        </div>
        <div className="mt-36 text-left mx-4 md:mx-0">
...
inputed and making sure only the absolutely necessary data was inputed to keep the process as simple and easy as possible.
        ...
        <div className="mt-36 text-left mx-4 md:mx-0">
            ...
            <img src='/img/agreements/Artboard-8.png' alt="Picture of the author" width="800" className="m-auto mt-8"/>
            <div className="my-36">
            <h1>What I learnt</h1>
            <p className="text-lg mt-6 text-gray-500">
